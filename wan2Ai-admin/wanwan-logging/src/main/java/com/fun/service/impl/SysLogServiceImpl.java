...
import com.fun.domain.SysLog;
import com.fun.mapper.SysLogMapper;
import com.fun.service.SysLogService;
import com.fun.domain.vo.SysLogQueryCriteria;
...
public class SysLogServiceImpl extends ServiceImpl<SysLogMapper, SysLog> implements SysLogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, SysLog sysLog) {
        ...
        com.fun.annotation.Log aopLog = method.getAnnotation(com.fun.annotation.Log.class);
